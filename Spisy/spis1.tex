...
\begin{document}
	...
	\end{proof}
		...
		Let us assume that the following configuration, after computing the point S, satisfies the condition \label{prop:R} for point R, and is therefore fully stretched.
	...
	figure N describes how possition of C for fixed A, B and its axis affects determination of S for minimalization of the tree.   
