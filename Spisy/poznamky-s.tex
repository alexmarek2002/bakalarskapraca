...
Prisne vzate je $f_{1},f_{2}\colon\mathbb{R}^{2}\to\mathbb{R}$ ale vacsina
    ...
    \begin{equation*}
        O
        =
        \{C\in\mathbb{R}\times\left[0,\infty\left[\,|\,|AC|\le|BC|\le|AB|\}
    \end{equation*}
...
Majme $C\in O$ (cize v plachetnici) a pohyubujme sa po vrstevnici $f_{1}$ v
    smere takeho vektora $v$, ktory zviera tupy uhol s vektorom $CA$ a ostry
    uhol s vektorom $CB$ -- to sa vzdy da, kedze smer $v$ je kolmy na $CS^{0}$.
...
Pretoze sme celu dobu v plachetnici, uhol $ACB$ je neustale prinajmensom
    $\pi/3$. 
Zarovnej, pretoze su stromy, ktorych cenu meraju $f_{1}$ a $f_{2}$ oba
    minimalne, maju oba
